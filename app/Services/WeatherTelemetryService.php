...
class WeatherTelemetryService
{
    ...
    /**
     * Fetch and store daily weather telemetry for a lake on a given date.
     *
     * @param Lake $lake
     * @param string $date YYYY-MM-DD
     * @return LakeDailyWeather|null
     */
    public function fetchForLakeAndDate(Lake $lake, string $date): ?LakeDailyWeather
    {
        // Return existing weather if already cached

...
35. **Map Explorer & Lake Dossier Bathymetry & Depth Contour Integration**:
    - Created curated GeoJSON bathymetry dataset ([`bathymetry-contours.geojson`](file:///home/gmroczek/git/fishing/public/json/bathymetry-contours.geojson)) featuring color-ramped depth isolines (5ft to 120ft) and underwater structure soundings (submerged rock reefs, deep holes, drop-off shelves, river channels, delta shoals) across primary Algoma / Wawa region fisheries.
    - Integrated multi-layer base switching (Standard Topo, OpenTopoMap Bathymetry & Relief, Esri Satellite, OpenSeaMap Nautical Soundings) and interactive depth overlays into [`explorer.blade.php`](file:///home/gmroczek/git/fishing/resources/views/map/explorer.blade.php).
    - Configured Bathymetry & Depth Contours as the **default** active map base on the Lake Dossier view ([`lake/show.blade.php`](file:///home/gmroczek/git/fishing/resources/views/lake/show.blade.php)).

        ...
        <form action="{{ url('/angler') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" id="middleName" name="middleName" value="{{ old('middleName', $angler->middleName) }}" class="w-full h-11 px-3.5 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-800 text-sm focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500" placeholder="Optional...">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                @else
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-xs font-bold uppercase tracking-wider text-slate-700">Linked User Account</label>
                        <div class="h-11 px-3.5 rounded-xl border border-slate-200 bg-slate-100/70 text-slate-600 text-sm flex items-center font-medium">
